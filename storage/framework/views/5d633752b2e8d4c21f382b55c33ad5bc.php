                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $rekap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><span class="tag p"><?php echo e($item->siswa->kelas ?? '-'); ?></span></td>
...
<div class="print-document">
    <div class="print-doc-inner">
        ...
        <div class="print-kop">
            ...
            <div class="print-kop-logo">
                <img src="<?php echo e(asset('images/logo-tut.png')); ?>" alt="Logo 2" onerror="this.style.display='none'">
            </div>
        </div>
        ...
        <div class="print-title">
            ...
            <p>Tahun Ajaran <?php echo e(date('Y')); ?>/<?php echo e(date('Y') + 1); ?> &mdash; Dicetak pada: <?php echo e(\Carbon\Carbon::now()->locale('id')->isoFormat('D MMMM Y, HH:mm')); ?> WIB</p>
        </div>

        
        <div class="print-summary">
            <div class="print-summary-item">
                <span class="sum-val"><?php echo e($rekap->count()); ?></span>
                <span class="sum-lbl">Total Siswa</span>
            </div>
            <div class="print-summary-item">
                <span class="sum-val"><?php echo e($rekap->sum('jumlah_pelanggaran')); ?></span>
                <span class="sum-lbl">Total Pelanggaran</span>
            </div>
            <div class="print-summary-item">
                <span class="sum-val"><?php echo e(number_format($rekap->avg('total_poin'), 1)); ?></span>
                <span class="sum-lbl">Rata-rata Poin</span>
            </div>
            <div class="print-summary-item">
                <span class="sum-val"><?php echo e($rekap->max('total_poin') ?? 0); ?></span>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $rekap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td style="font-weight:600;"><?php echo e($item->siswa->nama ?? '-'); ?></td>
                        <td><?php echo e($item->siswa->kelas ?? '-'); ?></td>
                        <td class="col-center"><?php echo e($item->jumlah_pelanggaran); ?> Kali</td>
                        <td class="col-center"><?php echo e($item->total_poin); ?> Poin</td>
                        <td class="col-center">
                            <?php if($item->total_poin > 15): ?>
        ...
        <div class="print-footer">
            <div class="print-signature">
                <p class="sig-city">Kota Contoh, <?php echo e(\Carbon\Carbon::now()->locale('id')->isoFormat('D MMMM Y')); ?></p>
