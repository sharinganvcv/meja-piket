    ...
    <div class="app-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <?php if(in_array(auth()->user()->role, ['admin', 'guru'])): ?>
                <div class="nav-section">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('laporan.izin')); ?>" class="nav-link <?php echo e(request()->routeIs('laporan.izin') ? 'active' : ''); ?>">
                        <i class="fas fa-file-alt"></i>
                        <span>Laporan Izin</span>
                    </a>
                    <a href="<?php echo e(route('laporan.keterlambatan')); ?>" class="nav-link <?php echo e(request()->routeIs('laporan.keterlambatan') ? 'active' : ''); ?>">
                        <i class="fas fa-file-invoice"></i>
                        <span>Laporan Terlambat</span>
                    </a>
                    <a href="<?php echo e(route('laporan.pelanggaran')); ?>" class="nav-link <?php echo e(request()->routeIs('laporan.pelanggaran') ? 'active' : ''); ?>">
        ...
        <main class="main-content">
            ...
            <div class="mobile-header">
                <div class="sidebar-brand" style="color: var(--sidebar-bg)">
                    <div class="brand-logo">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" style="width: 100%; height: 100%; object-fit: contain;">
                    </div>
