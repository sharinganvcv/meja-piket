...
<div class="db-wrap">
    ...
    <div class="db-topbar">
        <div class="db-greeting">
            ...
            <p><?php echo e(now()->format('l, d F Y')); ?> &bull; Sistem Manajemen Sekolah Eduspace</p>
        </div>
        <div class="db-time" id="liveClock"><?php echo e(now()->format('H:i')); ?></div>
    </div>
    ...
    <div class="stats-row">
        <div class="scard s1">
            ...
            <div class="sv"><?php echo e($totalSiswa); ?></div>
        ...
        <div class="scard s4">
            ...
            <div class="sv"><?php echo e($totalPelanggaran); ?></div>
        ...
        <div class="scard s5">
            ...
            <div class="sv"><?php echo e($totalIzin); ?></div>
        ...
        <div class="scard s6">
            ...
            <div class="sv"><?php echo e($totalPiket); ?></div>
    ...
    <div class="qa-box">
        ...
        <div class="qa-grid">
            ...
            <a href="<?php echo e(route($action['route'])); ?>" class="qa-item">
                <div class="qa-icon"><i class="<?php echo e($action['icon']); ?>"></i></div>
                <span class="qa-label"><?php echo e($action['title']); ?></span>
            </a>
            <?php endif; ?>
    ...
    <div class="db-mid">
            <div class="act-box">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentIzin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $izin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="act-item">
                    <div class="act-dot b"><i class="fas fa-door-open"></i></div>
                    <div style="flex:1;min-width:0">
                        <p class="act-title"><?php echo e($izin->siswa->nama ?? '-'); ?></p>
                        <p class="act-sub"><?php echo e($izin->alasan ?? 'Izin Keluar'); ?></p>
                    </div>
                    <span class="act-time"><?php echo e($izin->created_at->diffForHumans()); ?></span>
                </div>
            ...
            <div class="act-box">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentKeterlambatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="act-item">
                    <div class="act-dot r"><i class="fas fa-clock"></i></div>
                    <div style="flex:1;min-width:0">
                        <p class="act-title"><?php echo e($tl->siswa->nama ?? '-'); ?></p>
                        <p class="act-sub"><?php echo e($tl->keterangan ?? 'Terlambat'); ?></p>
                    </div>
                    <span class="act-time"><?php echo e($tl->created_at->diffForHumans()); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="act-item">
                    <div class="act-dot g"><i class="fas fa-check"></i></div>
...
new Chart(attendanceCtx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode($attendanceData['labels'], 15, 512) ?>,
        datasets: [{
            label: 'Hadir',
            data: <?php echo json_encode($attendanceData['hadir'], 15, 512) ?>,
            borderColor: '#667eea',
            ...
            label: 'Tidak Hadir',
            data: <?php echo json_encode($attendanceData['tidak_hadir'], 15, 512) ?>,
            borderColor: '#f093fb',
...
new Chart(distributionCtx, {
    type: 'doughnut',
    data: {
        labels: <?php echo json_encode($classDistribution['labels'], 15, 512) ?>,
        datasets: [{
            data: <?php echo json_encode($classDistribution['data'], 15, 512) ?>,
            backgroundColor: [
                '#667eea',
                '#43e97b',
                '#fa709a'
...
new Chart(piketCtx, {
    type: 'bar',
    data: {
        labels: <?php echo json_encode($piketStats['labels'], 15, 512) ?>,
        datasets: [{
            label: 'Jadwal Piket',
            data: <?php echo json_encode($piketStats['data'], 15, 512) ?>,
...
new Chart(lateCtx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode($lateTrend['labels'], 15, 512) ?>,
        datasets: [{
            label: 'Keterlambatan',
            data: <?php echo json_encode($lateTrend['data'], 15, 512) ?>,
            borderColor: '#f093fb',
            backgroundColor: 'rgba(240, 147, 251, 0.1)',
            borderWidth: 3,
            fill: true,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\antigravity\website-sekolah-main\resources\views/dashboard.blade.php ENDPATH**/ ?>