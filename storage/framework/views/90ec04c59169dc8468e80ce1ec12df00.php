...
<div class="dashboard-container">
    ...
    <div class="welcome-card">
        ...
        <div class="clock-widget">
            <div class="time" id="liveClock"><?php echo e(now()->format('H:i')); ?></div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $recentIzin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $izin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <div class="activity-name"><?php echo e($izin->siswa->nama ?? 'Siswa'); ?></div>
                                        <div class="activity-meta"><?php echo e($izin->alasan); ?></div>
                                    </div>
                        ...
                        <div class="activity-feed">
                            <?php $__empty_1 = true; $__currentLoopData = $recentKeterlambatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <div class="activity-name"><?php echo e($tl->siswa->nama ?? 'Siswa'); ?></div>
                                        <div class="activity-meta"><?php echo e($tl->keterangan); ?></div>
                                    </div>
                                    <div class="activity-time"><?php echo e($tl->created_at->diffForHumans()); ?></div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="card p-4 mb-4">
                ...
                <div class="quick-actions">
                    <?php $__currentLoopData = $roleBasedData['quickActions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route($action['route'])); ?>" class="action-btn">
            ...
            <div class="card p-4">
                ...
                <div class="system-status">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <span class="badge bg-primary rounded-pill"><?php echo e(strtoupper(auth()->user()->role)); ?></span>
                    </div>
                    <div class="d-flex justify-content-between mb-3">
                        <span class="text-muted">Waktu Server</span>
                        <span class="text-dark font-monospace"><?php echo e(now()->format('H:i:s')); ?></span>
                    </div>
